...
import * as generateIdMod from "../../../../../feature/app/function/generateId";
import * as calcNextIndexMod from "./calcNextIndex";
import { useSaveNewRecord } from "./useSaveNewRecord";

jest.mock("@v3/graphql/public");
jest.mock("../../../../../feature/app/function/generateId");
jest.mock("./calcNextIndex");
...
describe("useSaveNewRecord", () => {
  ...
  const setupMock = () => {
    ...
    jest.spyOn(calcNextIndexMod, "calcNextIndex").mockReturnValue(3);
    jest.spyOn(generateIdMod, "generateId").mockReturnValue("12345");
