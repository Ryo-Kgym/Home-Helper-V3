...
export type GetDailyAttendanceQueryVariables = Types.Exact<{
  date: Types.Scalars["date"];
  groupId: Types.Scalars["String"];
  userId: Types.Scalars["String"];
}>;

export type GetDailyAttendanceQuery = {
...
export const GetDailyAttendanceDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "getDailyAttendance" },
      variableDefinitions: [
        {
  ...
  GetDailyAttendanceQueryVariables
>;
